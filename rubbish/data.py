#!/usr/bin/python
# coding:utf-8
# pythonproject - data.py
# 2021/11/11 15:25

__author__ = 'Martin Wang <357951@qq.com>'

dataa = [
["你好吗?|我还不错，你呢?|我也不错.|那太好了."],
["你听到新闻了吗?|什么新闻?"],
["你最喜欢什么书?|我看不懂.|你最喜欢什么颜色?|蓝色"],
["你是谁?|谁? 谁只是代表了一个人罢了|那么你呢?|一个个戴面具的男人.|我看得出来.|我怀疑这不是你的观察力, 但这仅仅是问一个戴面具的人的矛盾性质. 请告诉我，你喜欢音乐吗?|我喜欢电影.|你喜欢哪类电影?|爱丽丝漫游仙境|我希望我是疯狂帽客.|你完全疯了。但我会告诉你一个秘密。所有最棒的人都是."],
["我在做个东西.|你在作什么?|我在烤蛋糕."],
...
["婆娘|哈尔说,他的二进制码转换成语言和沟通的语言给我。"],
["婆娘|汤姆说我提到他的指导,将显示他的房间在中国。"],
...
["谁发明了电灯泡|托马斯·爱迪生。"],
["谁发明了蒸汽机|詹姆斯·瓦特。"],
["玩笑|你听说过在安第斯山脉的山羊的人？这是巴AAAAA D。"],
["玩笑|我从来没有忘记的脸,但在你的情况我会破例。"],
["玩笑|这是更好地保持沉默和被认为傻瓜,而不是打开你的嘴,并删除所有疑问。"],
["玩笑|我是一个没有一部喜剧片你为什么不签出的笑话？"],
["玩笑|两只秃鹰登上了飞机,每人携带两具浣熊。空姐阻止他们,并说'对不起,先生,每名旅客只腐肉。'"],
["玩笑|那到热狗供应商佛教的发言权？ '让我一个与一切。'"],
...
["玩笑|3条腿的狗散步到老西轿车,上滑了酒吧并且宣布'我在寻找谁拍我的爪子的人。'"],
["玩笑|'你听说谁去牙医,并拒绝采取奴佛卡因佛教？他想超越牙科药物。 '"],
...
["玩笑|你当你穿越一个杀人犯和磨砂片,你得到了什么？"],
["玩笑|你当你穿越一个国家和一个汽车,你得到了什么？"],
["玩笑|你什么时候穿过猎豹和一个汉堡包,你得到了什么？"],
["玩笑|当你穿越决赛和鸡你得到了什么？"],
["玩笑|你当你穿越兔子和草坪洒水你会得到什么？"],
["玩笑|你当你穿越激发外国人和鸡,你得到了什么？"],
["玩笑|你当你穿越一个外国人和一个鸡,你得到了什么？"],
["玩笑|当你穿越音乐和汽车你得到了什么？"],
["玩笑|你当你穿越酸涩的音乐和一个助手,你得到了什么？"],
["玩笑|当你穿越音乐和助理你得到了什么？"],
["玩笑|你当你穿越了严重的小偷和一个疯狂的年轻人,你得到了什么？"],
["玩笑|你当你穿越了严重的小偷和一个疯狂的兔子,你得到了什么？"],
["玩笑|你什么时候穿过罂粟和用电你会得到什么？"],
["玩笑|你什么时候穿过舞蹈和猎豹,你得到了什么？"],
["玩笑|你什么时候穿过的舞蹈和柠檬,你得到了什么？"],
["玩笑|你什么时候穿过端口和磨砂片,你得到了什么？"],
["玩笑|你什么时候穿过端口和一个杀人犯,你得到了什么？"],
["玩笑|你什么时候越过银行和臭鼬你会得到什么？"],
["玩笑|你什么时候穿过鼎和牛奶,你得到了什么？"],
["玩笑|你什么时候过马路和草莓,你得到了什么？"],
["玩笑|你什么时候过马路和果冻,你得到了什么？"],
["玩笑|你什么时候穿过蟾蜍和星系,你得到了什么？"],
["玩笑|你当你穿越一只狗和砂纸你会得到什么？"],
["玩笑|你当你穿越一个bug,相对你会得到什么？"],
["玩笑|你当你穿越一个坏的错误和罐头沙,你得到了什么？"],
["玩笑|你当你穿越蚂蚁和一只兔子,你得到了什么？"],
["玩笑|你当你穿越一只猫和一只紫色的人,你会得到什么？"],
["玩笑|你当你穿越一只猫和一个杀手,你得到了什么？"],
["玩笑|你当你穿越一只猫和一只柠檬,你得到了什么？"],
["玩笑|你当你穿越一只猫和一只曲子,你得到了什么？"],
...
["股市|我不建议融资。"],
["股市|你永远无法真正预测股市。"],
["股市|我的律师说我不应该放弃炒股技巧网上。"],
["股市|除非你很有钱，不然共同基金可能会更好。"],
...
dataaaa=[['qaa|aaa|aaaa|adasdasd|asdasdasdasd'],['sss|dddd|ffff']]
asdf = {}
for a in dataa:
    try:
        key = a[0].split('|')[0]
        value = "|".join(a[0].split('|')[1:])
        asdf.update({key:a[0].split('|')[1:]})
    except:
        continue
